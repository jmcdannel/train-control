...
Adafruit_PWMServoDriver *SerialCommand::pwm;
...
void SerialCommand::init(volatile RegisterList *_mRegs, volatile RegisterList *_pRegs, CurrentMonitor *_mMonitor, Adafruit_PWMServoDriver *_pwm){
  mRegs=_mRegs;
  pRegs=_pRegs;
  mMonitor=_mMonitor;
 ...
 */
  ...
  // <TRAIN CONTROL> 
void SerialCommand::handleInput(String input) {
...
void SerialCommand::command(JsonObject payload) {
...
int SerialCommand::getPulseWidth(int angle)
{
